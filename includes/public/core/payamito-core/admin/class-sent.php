...
?>
				...
				<div class="container">
					...
					<div class="p-2">
						...
						<div class="row">
							...
							<div class="card">
								<h5 class="card-header"><?php _e('Log Export', 'payamito'); ?></h5>
								<div class="card-body">
									<p class="card-text"><?php _e('You can output the desired reports using the following options', 'payamito') ?></p>
									...
									<div class="row py-3 g-3">
										...
										<div class="col-12">
											<label class="form-label" for="payamito-status"><?php _e('columns', 'payamito'); ?></label>
											<select style="with:100%" multiple class="paymito-chosen-select" id="payamito-columns" name="payamito-columns" placeholder="<?php _e('Columns', 'payamito'); ?>">
												<option value="id"><?php _e('ID', 'payamito'); ?></option>
												<option value="status"><?php _e('Status', 'payamito'); ?></option>
												<option value="reciever"><?php _e('Reciever', 'payamito'); ?></option>
												<option value="message"><?php _e('Message', 'payamito'); ?></option>
												<option value="method"><?php _e('Method', 'payamito'); ?></option>
												<option value="slug"><?php _e('Operative', 'payamito'); ?></option>
												<option value="date"><?php _e('Date', 'payamito'); ?></option>
											</select>
										</div>
										...
										<div class="col-sm-6">
											...
											<label class="form-label" for="payamito-status"><?php _e('Status', 'payamito'); ?></label>
											<select id="payamito-status" class="paymito-chosen-select" name="payamito-status" placeholder="<?php _e('Status', 'payamito'); ?>">
												<option value="all"><?php _e('All', 'payamito'); ?></option>
												<option value="1"><?php _e('Success', 'payamito'); ?></option>
												<option value="0"><?php _e('Filed', 'payamito'); ?></option>
											</select>

										</div>


										<div class="col-sm-6"><label class="form-label" for="payamito-method"><?php _e('Method', 'payamito'); ?></label>
											<select id="payamito-method" class="paymito-chosen-select" name="payamito-method" placeholder="<?php _e('Method', 'payamito'); ?>">
												<option value="all"><?php _e('All', 'payamito'); ?></option>
												<option value="1"><?php _e('Pattern', 'payamito'); ?></option>
												<option value="2"><?php _e('Message', 'payamito'); ?></option>
											</select>
										</div>


										<div class="col-sm-6"><label class="form-label" for="payamito-operative"><?php _e('Operative', 'payamito'); ?></label>

											<select id="payamito-operative" class="paymito-chosen-select" name="payamito-operative" placeholder="<?php _e('Operative:', 'payamito'); ?>">
												<option value="all"><?php _e('All', 'payamito'); ?></option>
												<option value="payamito_edd"><?php _e('Easy digital downloads', 'payamito'); ?></option>
												<option value="payamito_um"><?php _e('Ultimate member', 'payamito'); ?></option>
												<option value="payamito_wc"><?php _e('Woocommerce', 'payamito'); ?></option>
												<option value="payamito_vv"><?php _e('Vendor verification', 'payamito'); ?></option>
												<option value="payamito_gf"><?php _e('Gravity form', 'payamito'); ?></option>
												<option value="payamito_as"><?php _e('Awesome Support', 'payamito'); ?></option>
												<option value="payamito_el"><?php _e('Elementor', 'payamito'); ?></option>
												<option value="direct_send"><?php _e('Direct send', 'payamito'); ?></option>
											</select>
										</div>


										<div class="col-sm-6">
											<label class="form-label" for="payamito-reciever"><?php _e('Reciever', 'payamito'); ?></label>
											<input type="number" class="form-control" id="payamito-reciever" name="payamito-reciever" />
										...
										<div class="col-sm-6">
											...
											<label class="form-label" for="payamito-limit"><?php _e(' Limit', 'payamito'); ?></label>
											<input maxlength="9" type="number" class="form-control" id="payamito-limit" name="payamito-limit" />
										</div>


										<div class="col-12">
											<input type="button" name="payamito-btn-extend" id="payamito_btn_extend" class="btn btn-primary form-label" value="<?php _e('Export', 'payamito'); ?>" />
		...
		public static function prepare_message($message)
		{
			...
			$message = isset($message) && $message != "" ? unserialize($message) : false;
